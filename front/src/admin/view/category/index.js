          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 className="text-white text-capitalize ps-3">Category table</h6>
                <Link to="../admin/category/add" >
                  <Button variant="contained" style={{marginLeft: "12px"}}>Add Category+</Button>  
                </Link>
              </div>
            </div>
                ...
                <table className="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="align-middle">
                        <Link to="to" className="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </Link>
                      </td>
                    </tr>
